...
description: Use when a Kotlin-specific setup or design decision is needed (coroutine structuring, null-safety idioms, DSL builder design) — not for routine Kotlin edits the model already knows how to make.
origin: ECC
---
