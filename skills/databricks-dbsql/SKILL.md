...
description: 'Databricks SQL (DBSQL) advanced features: SQL scripting/stored procedures, materialized views, pipe syntax (|>), recursive CTEs, geospatial (H3/ST_), collations, AI functions (ai_query etc.), http_request/remote_query/read_files, Lakehouse Federation, and DBSQL data-modeling best practices.'
...
### Geospatial (H3/ST_) & Collations

H3 proximity search and case-insensitive collation examples are in [references/geospatial-collations.md](references/geospatial-collations.md).
