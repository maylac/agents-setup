...
description: "Unity Catalog governance, access control, and observability: GRANT/REVOKE, the privilege model and ownership, row-level security and column masks, external locations and storage credentials, catalogs/schemas/tables/volumes, and system tables (audit, lineage, billing)."
...
- **databricks-pipelines**, **databricks-jobs** — *producing* tables via pipelines/jobs
- **databricks-dbsql** — SQL features and data modeling over governed tables
