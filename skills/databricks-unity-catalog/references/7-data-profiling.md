...
monitor = w.data_quality.create_monitor(
    monitor=Monitor(
        ...
        data_profiling_config=DataProfilingConfig(
            assets_dir="/Workspace$HOME@example.com/monitoring/my_table",
...
monitor = w.data_quality.create_monitor(
    monitor=Monitor(
        ...
        object_id=table_info.table_id,
        data_profiling_config=DataProfilingConfig(
            assets_dir="/Workspace$HOME@example.com/monitoring/events",
            output_schema_id=schema_info.schema_id,
...
monitor = w.data_quality.create_monitor(
    monitor=Monitor(
        ...
        object_id=table_info.table_id,
        data_profiling_config=DataProfilingConfig(
            assets_dir="/Workspace$HOME@example.com/monitoring/predictions",
            output_schema_id=schema_info.schema_id,
