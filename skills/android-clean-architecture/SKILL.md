...
description: Clean Architecture patterns for Android/KMP — module structure, dependency rules, UseCases, Repositories, data-layer patterns — not for routine edits within an existing architecture.
origin: ECC
---
