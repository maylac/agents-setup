---
name: hatch-pet
description: Create, repair, validate, visually QA, and package Codex-compatible animated pet spritesheets and pet.json assets.
---
...
The brand-discovery worker prompt, handoff fields, and delegation contract are in [references/brand-discovery.md](references/brand-discovery.md).
