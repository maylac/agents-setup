...
List/run/cancel/monitor jobs via the `databricks jobs` CLI and DABs deploy — see the databricks-core skill for the Asset Bundle deploy workflow and CLI basics.
...
- **databricks-core** — CLI basics, authentication, and DABs (Asset Bundle) deployment workflow
